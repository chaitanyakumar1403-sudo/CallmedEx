...
export const PATIENT_TRANSLATIONS: Record<PatientLang, PatientTranslations> = {
  en: {
    ...
    smartMedicineCabinet: "My Medicines",
    medicineCabinetSubtitle: "Doses, reminders and refills in one place.",
    addMedication: "Add Medication",
    noMedicationsTitle: "No medicines added yet",
    noMedicationsBody: "Add what you take to get dose reminders and a heads-up before you run out.",
    ...
    kpi: {
      upcoming: "Upcoming",
      upcomingSub: "Appointments booked",
      completed: "Completed",
      completedSub: "Visits and tests done",
      prescriptions: "Medicines",
      prescriptionsSub: "Being tracked",
      records: "Health Records",
      recordsSub: "Reports on file",
    },
    allottedSlots: {
