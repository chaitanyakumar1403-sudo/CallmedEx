    ...
    <div style={{ backgroundColor: "var(--cm-surface)", color: "var(--cm-ink)", minHeight: "100vh" }}>
      ...
      <section style={{ borderBottom: "1px solid var(--cm-line)", padding: "72px 24px 64px", background: "var(--cm-surface)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 48, alignItems: "center" }}>
          <div>
            ...
            <h1 style={{ fontFamily: "var(--cm-font-display)", margin: "0 0 20px 0", fontSize: "clamp(2rem, 4vw, 3.2rem)", fontWeight: 700, color: "var(--cm-navy)", letterSpacing: "-0.025em", lineHeight: 1.15 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20, borderTop: "1px solid var(--cm-line)", paddingTop: 24 }}>
              ...
              <div>
                <div style={{ fontFamily: "var(--cm-font-display)", fontSize: "var(--cm-text-2xl)", fontWeight: 700, letterSpacing: "-0.02em", color: "var(--cm-active)", fontVariantNumeric: "tabular-nums" }}>200+</div>
                <div style={{ fontSize: "var(--cm-text-xs)", color: "var(--cm-ink-3)", fontWeight: 600 }}>Verified Biomarkers</div>
              </div>
              <div>
                <div style={{ fontFamily: "var(--cm-font-display)", fontSize: "var(--cm-text-2xl)", fontWeight: 700, letterSpacing: "-0.02em", color: "var(--cm-done)", fontVariantNumeric: "tabular-nums" }}>10K+</div>
          ...
          <div className="cm-card" style={{ padding: 28, border: "1px solid var(--cm-line)", borderRadius: "var(--cm-radius)", background: "var(--cm-surface)", boxShadow: "0 20px 40px -15px rgba(0,0,0,0.06)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, borderBottom: "1px solid var(--cm-line)", paddingBottom: 16 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div>
                  <div style={{ fontFamily: "var(--cm-font-display)", fontWeight: 700, letterSpacing: "-0.01em", fontSize: "var(--cm-text-sm)", color: "var(--cm-ink)" }}>Live Clinical Dispatch</div>
                  <div style={{ fontSize: "var(--cm-text-xs)", color: "var(--cm-done)", display: "flex", alignItems: "center", gap: 4, fontWeight: 600 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 20 }}>
              <div style={{ padding: 12, borderRadius: "var(--cm-radius-sm)", background: "var(--cm-surface-2)", border: "1px solid var(--cm-line)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    <div style={{ fontSize: "var(--cm-text-xs)", fontWeight: 600, color: "var(--cm-ink)" }}>Complete Blood Count (CBC)</div>
              ...
              <div style={{ padding: 12, borderRadius: "var(--cm-radius-sm)", background: "var(--cm-surface-2)", border: "1px solid var(--cm-line)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    <div style={{ fontSize: "var(--cm-text-xs)", fontWeight: 600, color: "var(--cm-ink)" }}>General Physician Teleconsult</div>
              ...
              <div style={{ padding: 12, borderRadius: "var(--cm-radius-sm)", background: "var(--cm-surface-2)", border: "1px solid var(--cm-line)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    <div style={{ fontSize: "var(--cm-text-xs)", fontWeight: 600, color: "var(--cm-ink)" }}>Prescription Dispensation</div>
            ...
            <div style={{ fontSize: "var(--cm-text-xs)", color: "var(--cm-ink-3)", display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "1px solid var(--cm-line)", paddingTop: 14 }}>
              ...
              <span style={{ fontWeight: 600, color: "var(--cm-ink)" }}>NMC 2026 Compliant</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "64px 24px", background: "var(--cm-surface)", borderBottom: "1px solid var(--cm-line)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <h2 style={{ fontFamily: "var(--cm-font-display)", margin: "0 0 10px 0", fontSize: "var(--cm-text-2xl)", fontWeight: 700, letterSpacing: "-0.02em", color: "var(--cm-navy)", lineHeight: 1.2 }}>
              Clinical Healthcare Services, Coordinated
            </h2>
            <p style={{ margin: 0, fontSize: "var(--cm-text-sm)", color: "var(--cm-ink-3)", maxWidth: 540, marginInline: "auto", lineHeight: 1.55 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20 }}>
            ...
            <div className="cm-card" style={{ padding: 24, border: "1px solid var(--cm-line)", borderRadius: "var(--cm-radius)", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
              <div>
                ...
                <h3 style={{ fontFamily: "var(--cm-font-display)", margin: "0 0 8px 0", fontSize: "var(--cm-text-base)", fontWeight: 700, letterSpacing: "-0.015em", color: "var(--cm-ink)" }}>
      ...
      <section style={{ padding: "64px 24px", background: "var(--cm-navy)", color: "#ffffff", textAlign: "center" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <h2 style={{ fontFamily: "var(--cm-font-display)", color: "#ffffff", margin: "0 0 16px 0", fontSize: "var(--cm-text-2xl)", fontWeight: 700, letterSpacing: "-0.02em", lineHeight: 1.2 }}>
